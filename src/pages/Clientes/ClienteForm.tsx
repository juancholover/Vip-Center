    ...
    <div className="fixed inset-0 z-50 bg-black/70 grid place-items-center px-4">
      <div className="w-full max-w-xl rounded-xl bg-[#171B22] border border-white/10 p-6 relative animate-fadeIn">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          ...
          {/* DNI */}
          <div>
            <label className="text-xs text-slate-400">DNI</label>
            <input
              name="dni"
              value={form.dni}
              onChange={handleChange}
          ...
          <div className="col-span-2">
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={3}
              className="w-full mt-1 bg-[#0F1318] border border-white/10 rounded-lg px-3 py-2 text-sm outline-none focus:border-emerald-500 resize-none"
            />
          </div>
